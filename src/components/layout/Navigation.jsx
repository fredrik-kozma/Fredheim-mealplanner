...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    to: '/nutrition',
    icon: (active) => (
      // Heart-with-pulse — "what you eat, tracked"
      <svg className="w-5 h-5" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={active ? 0 : 1.8} viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
        {!active && <path strokeLinecap="round" strokeLinejoin="round" d="M6.5 11.5h3l1.5-3 2 5 1.5-2h3" />}
      </svg>
    ),
  },
  {
          ...
          {user ? (
            <div className="space-y-2">
              ...
              <a
                ...
                className="w-full text-left px-3 py-1.5 rounded-lg text-xs text-slate-400 hover:bg-slate-50 hover:text-indigo-600 transition-colors flex items-center gap-1.5"
              >
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                </svg>
                {t('settings.contactSupport', { defaultValue: 'Support' })}
              </a>
            </div>
          ) : (
            <div className="space-y-2">
